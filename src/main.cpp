    ...
    const double MAX_SPEED = 50. - 0.03;
        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
          ...
          if (s != "") {
            ...
            if (event == "telemetry") {
              ...
              bool is_target_lane = car_d < lane_center + 2 && car_d > lane_center - 2;
              ...
              if (ref_velocity >= MAX_SPEED - 0.5) {
                cout << car_speed << ", " << ref_velocity << endl;
              }
