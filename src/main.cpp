...
//}
//
//typedef std::vector<double> sensor_fusion_car;    //
//typedef std::vector<sensor_fusion_car> sensor_fusion;    //
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // 0.5 meters = 25 m/sec = 90 km/h = 50 m/h
          double dist_inc = 0.5;
          for (int i = 0; i < 50; i++) {
            double next_s = car_s + (i + 1) * dist_inc;
            double next_d = 6; // stay in line
            vector<double> xy = getXY(next_s, next_d, map_waypoints_x, map_waypoints_y);
          }
